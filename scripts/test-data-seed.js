    ...
    const modules = [
      {
        ...
        lessons: [
          { title: 'Знакомство с инструментами', duration: '12:30', isFree: true,
          ...
          { title: 'Санитарные нормы и стерилизация', duration: '18:45', isFree: true,
          ...
          { title: 'Формы и архитектура ногтя', duration: '24:10', isFree: false,
      ...
      },
      {
        ...
        lessons: [
          { title: 'Виды фрез и их применение', duration: '22:00', isFree: false,
          ...
          { title: 'Техника снятия кутикулы', duration: '32:15', isFree: false,
          ...
          { title: 'Полировка и подготовка под покрытие', duration: '15:30', isFree: false,
      ...
      },
      {
        ...
        lessons: [
          { title: 'Базы и топы — как выбрать', duration: '20:00', isFree: false,
          ...
          { title: 'Аккуратное покрытие сложных форм', duration: '28:45', isFree: false,
          ...
          { title: 'Простой дизайн градиентом', duration: '14:20', isFree: false,
    ...
    for (const m of modules) {
      ...
      for (const l of m.lessons) {
        await p.lesson.create({
          data: { moduleId: mod.id, title: l.title, duration: l.duration, isFree: l.isFree, videoUrl: '', content: l.content, order: lesOrder++ },
        });
      }
    }

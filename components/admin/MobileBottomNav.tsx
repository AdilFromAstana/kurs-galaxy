...
import { LayoutDashboard, BookOpen, Users, Award, Settings } from "lucide-react";
...
export function MobileBottomNav() {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-gray-100 md:hidden z-40 safe-area-inset-bottom">
        <div className="flex items-center justify-around px-2 py-2">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <Icon
                  className={`w-6 h-6 ${isActive ? "text-primary-600" : ""}`}
                />
